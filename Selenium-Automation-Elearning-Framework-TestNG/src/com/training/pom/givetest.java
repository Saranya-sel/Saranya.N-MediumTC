...
public class givetest {
	...
	public givetest(WebDriver driver) {
		this.driver = driver; 
   ...
   // private WebElement clicksearchagain; 
    ...
    private WebElement clicktesticon; 
	
	@FindBy(xpath="//*[contains(text(),'MockTest')]")
...
public void SendAnswer() {
	...
	js.executeScript("arguments[0].innerHTML = '<h1>Sum of 2 numbers</h1>'", sendanswer);
